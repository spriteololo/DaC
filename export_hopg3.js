...
function foundry(tm) {
    ...
    if (tm == 10) {
        document.getElementById("melt").innerHTML = ""
            ...
            + "background:url(https://" + hostname_oil + "/img/arrow/mytime.gif) no-repeat right center;\" id=\"mytime\">"
            + "<img border=0 src=https://" + hostname_oil + "/img/arrow/checkbox.gif width=48 height=22 "
            + "onclick=\"MainSwitch(12);\" oncontextmenu=\""
            + "val=byid('myfort').style.display;"
            + "if(val=='block') {"
...
function Run() {
    ...
    if (a > 0) { //TODO
        ...
        if (ME.id == 203718846) { // me
            mbClon = 9929832;//TODO +
            mbHP = 9905581;
            mbStone = 10172121;//TODO +
            mbFireBall = 10172122;//TODO+
            mbArmor = 23492038;//TODO +
            mbFreeze = 10172123;//TODO+
            mbPereman = 10172125;//TODO+
            mbCurse = 23492038;//TODO+
            abilityFireDust = 0;
            abilityKill = 0;
            abilityAbort = 0;
            abilityCloneDispel = 0;
